            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'all' ? 'active' : '' ?>" href="<?= base_url('death-cetificate-request/my-request?status=all') ?>">
                                <i class="fas fa-list me-1"></i> Semua
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'pending' ? 'active' : '' ?>" href="<?= base_url('death-cetificate-request/my-request?status=pending') ?>">
                                <i class="fas fa-clock me-1"></i> Menunggu
                                <span class="badge bg-warning text-dark"><?= $pendingCount ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'processing' ? 'active' : '' ?>" href="<?= base_url('death-cetificate-request/my-request?status=processing') ?>">
                                <i class="fas fa-spinner me-1"></i> Diproses
                                <span class="badge bg-info text-dark"><?= $processingCount ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'approved' ? 'active' : '' ?>" href="<?= base_url('death-cetificate-request/my-request?status=approved') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'completed' ? 'active' : '' ?>" href="<?= base_url('death-cetificate-request/my-request?status=completed') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'rejected' ? 'active' : '' ?>" href="<?= base_url('death-cetificate-request/my-request?status=rejected') ?>">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url('death-cetificate-request/my-request/create') ?>" class="btn btn-primary mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const table = $('#letterRequestsTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?= base_url('death-cetificate-request/getDataTable') ?>',
                type: 'GET',
                data: function(d) {
                    d.status = status;
