        ...
        <div class="col-md-12">
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="mb-0">Edit Pengajuan SK Domisili</h5>
                    <a href="<?= base_url('domicile-request') ?>" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    <form action="<?= base_url('domicile-request/update/' . $request['id']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik" maxlength="16" value="<?= old('nik', $request['nik']) ?>" readonly required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="kk" name="kk" value="<?= old('kk', $request['kk']) ?>" readonly>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control" id="rt" name="rt" value="<?= old('rt', $request['rt']) ?>" readonly>
                            </div>
                            <div class="col-md-2">
                                <label for="rw" class="form-label">RW <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="rw" name="rw" value="<?= old('rw', $request['rw']) ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="purpose" name="purpose" rows="3" required><?= old('purpose', $request['purpose']) ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3"><?= old('description', $request['description']) ?></textarea>
                            </div>
                        </div>
