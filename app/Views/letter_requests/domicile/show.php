        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Informasi Surat Keterangan Domisili</h5>
                    <div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table table-borderless">
                                ...
                                <?php endif; ?>
                                <?php if (!empty($request['valid_from'])): ?>
                                <tr>
                                    <td>Berlaku Mulai</td>
                                    <td>: <?= date('d F Y', strtotime($request['valid_from'])) ?></td>
                                </tr>
                                <?php endif; ?>
                            </table>
                        </div>
