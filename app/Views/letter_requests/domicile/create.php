        ...
        <div class="col-md-12">
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="mb-0">Buat SK Domisili</h5>
                ...
                <div class="card-body">
                    <form action="<?= base_url('domicile-request/store') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="kk" name="kk" value="<?= old('kk') ?>" readonly>
                            </div>
                            <div class="col-md-4">
