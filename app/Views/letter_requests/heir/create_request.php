                    ...
                    <form action="<?= base_url('heir-request/my-request/store') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik" maxlength="16" value="<?= old('nik', $resident['nik']) ?>" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <input type="hidden" class="form-control" readonly id="village_head_name" name="village_head_name" value="<?= old('village_head_name', $kades['value']) ?>" required>
                        <input type="hidden" class="form-control" readonly id="village_head_nip" name="village_head_nip" value="<?= old('village_head_nip', $kades['description']) ?>" required>
                        <input type="hidden" class="form-control" readonly id="village_head_position" name="village_head_position" value="<?= old('village_head_position', $kades['label']) ?>" required>
                        <input type="hidden" class="form-control" readonly id="subdistrict_head_name" name="subdistrict_head_name" value="<?= old('subdistrict_head_name', $camat['value']) ?>" required>
                        <input type="hidden" class="form-control" readonly id="subdistrict_head_nip" name="subdistrict_head_nip" value="<?= old('subdistrict_head_nip', $camat['description']) ?>" required>
                        <input type="hidden" class="form-control" readonly id="subdistrict_head_position" name="subdistrict_head_position" value="<?= old('subdistrict_head_position', $camat['label']) ?>" required>
