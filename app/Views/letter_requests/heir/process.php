        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?= base_url('heir-request/view/'.$request['id']) ?>" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    <td width="18%">Tanggal Kematian</td>
                                    <td>: <?= date('d F Y', strtotime($request['date_of_death'])) ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>: <?= date('d F Y', strtotime($request['burial_date'])) ?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= date('d F Y', strtotime($heir['birth_date'])) ?></td>
                                            <td><?= $heir['relationship'] ?></td>
                                            <td><?= $heir['nik'] ?></td>
                                            <td><?= $heir['is_reporter'] ? 'Ya' : 'Tidak' ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('heir-request/update-status/'.$request['id']) ?>" method="post">
                                        <div class="row mb-3">
