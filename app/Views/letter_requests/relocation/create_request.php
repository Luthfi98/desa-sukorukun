        ...
        <div class="col-md-12">
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="<?= base_url('relocation-request/my-request') ?>" class="btn btn-secondary btn-sm">
                ...
                <div class="card-body">
                    <form action="<?= base_url('relocation-request/my-request/store') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nik" name="nik" maxlength="16" value="<?= old('nik', $resident['nik']) ?>" required readonly>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="education" name="education" value="<?= old('education', $resident['education']) ?>" required>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="followersTable">
                                                ...
                                                <tbody>
                                                <?php 
                                                    $oldFollowerNames = old('foll_name') ?? [''];
                                                    $oldFollowerGenders = old('foll_gender') ?? [''];
                                                    $oldFollowerAges = old('foll_age') ?? [''];
                                                    $oldFollowerMaritalStatuses = old('foll_marital_status') ?? [''];
                                                    $oldFollowerEducations = old('foll_education') ?? [''];
                                                    $oldFollowerIdCards = old('foll_id_card') ?? [''];

                                                    $rowCount = max(
                                                        count($oldFollowerNames),
                                                        count($oldFollowerGenders),
                                                        count($oldFollowerAges),
                                                        count($oldFollowerMaritalStatuses),
                                                        count($oldFollowerEducations),
                                                        count($oldFollowerIdCards)
                                                    );
