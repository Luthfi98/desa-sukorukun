            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'all' ? 'active' : '' ?>" href="<?= base_url('general-request?status=all') ?>">
                                <i class="fas fa-list me-1"></i> Semua
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'pending' ? 'active' : '' ?>" href="<?= base_url('general-request?status=pending') ?>">
                                <i class="fas fa-clock me-1"></i> Menunggu
                                <span class="badge bg-warning text-dark"><?= $pendingCount ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'processing' ? 'active' : '' ?>" href="<?= base_url('general-request?status=processing') ?>">
                                <i class="fas fa-spinner me-1"></i> Diproses
                                <span class="badge bg-info text-dark"><?= $processingCount ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'approved' ? 'active' : '' ?>" href="<?= base_url('general-request?status=approved') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'completed' ? 'active' : '' ?>" href="<?= base_url('general-request?status=completed') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $status === 'rejected' ? 'active' : '' ?>" href="<?= base_url('general-request?status=rejected') ?>">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url('general-request/create') ?>" class="btn btn-primary mb-3">
