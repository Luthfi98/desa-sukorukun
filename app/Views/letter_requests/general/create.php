    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('general-request/store') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="valid_from" class="form-label">Tanggal Berlaku <span class="text-danger">*</span></label>
