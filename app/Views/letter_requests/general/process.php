        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?= base_url('general-request/view/'.$request['id']) ?>" class="btn btn-secondary btn-sm">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('general-request/update-status/'.$request['id']) ?>" method="post">
                                        <div class="row mb-3">
