...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3">Tambah Jenis Surat</h1>
        <div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('letter-types/create') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= ($validation->hasError('template')) ? 'is-invalid' : '' ?>" 
                                      id="template" name="template" rows="5"><?= old('template') ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= ($validation->hasError('required_documents')) ? 'is-invalid' : '' ?>" 
                                      id="required_documents" name="required_documents" rows="3"><?= old('required_documents') ?></textarea>
