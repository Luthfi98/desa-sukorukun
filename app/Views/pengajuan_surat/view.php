        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?= base_url('pengajuan-surat?status='.$request['status']) ?>" class="btn btn-secondary btn-sm">
                            <i class="fas fa-arrow-left"></i> Kembali
                        </a>
                        
                        <?php if($request['status'] === 'pending'): ?>
                            <a href="<?= base_url('pengajuan-surat/process/'.$request['id']) ?>" class="btn btn-warning btn-sm">
                        ...
                        <?php if($request['status'] === 'approved' || $request['status'] === 'completed'): ?>
                            <a href="<?= base_url('pengajuan-surat/download/'.$request['id']) ?>" class="btn btn-primary btn-sm" target="_blank">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            ...
                            <form action="<?= base_url('pengajuan-surat/update-status/' . $request['id']) ?>" method="post" class="d-inline-block">
...
<div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('pengajuan-surat/update-status/' . $request['id']) ?>" method="post">
